...
export const CAGED_SHAPES: Record<string, CagedShape> = {
  ...
  'G-minor':  { frets: [3, 3, 3, 5, 5, 3], fingers: [1, 1, 1, 3, 4, 1], baseRoot: 'G' },
  'G-7':      { frets: [3, 2, 0, 0, 0, 1], fingers: [3, 2, 0, 0, 0, 1], baseRoot: 'G' },
  'G-m7':     { frets: [3, 3, 3, 3, 5, 3], fingers: [1, 1, 1, 1, 3, 1], baseRoot: 'G' },
...
export const CHORD_VOICINGS: Record<string, ChordVoicing> = {
  ...
  'F-dim':    { frets: [1, -1, 1, 2, 1, -1], fingers: [1, 0, 2, 3, 1, 0] },
  'F-aug':    { frets: [1, 1, 2, 3, 3, 2], fingers: [1, 1, 2, 4, 3, 2] },
  'F-sus4':   { frets: [1, 1, 3, 3, 3, 1], fingers: [1, 1, 2, 3, 4, 1] },
  'F-sus2':   { frets: [1, 1, 3, 3, 1, 1], fingers: [1, 1, 3, 4, 1, 1] },
  'F-7sus4':  { frets: [1, 1, 1, 3, 3, 1], fingers: [1, 1, 1, 3, 4, 1] },
  'F-dim7':   { frets: [1, 2, 1, 2, -1, -1], fingers: [1, 3, 2, 4, 0, 0] },
  'F-m7b5':   { frets: [1, 1, 1, 1, -1, -1], fingers: [1, 2, 3, 4, 0, 0] },
  'F-add9':   { frets: [1, 1, 2, 3, 1, 1], fingers: [1, 1, 2, 4, 1, 1] },
  'F-9':      { frets: [1, 1, 2, 1, 1, 1], fingers: [1, 1, 2, 1, 1, 1] },
  ...
  'G-dim':    { frets: [3, -1, 3, 4, 3, -1], fingers: [1, 0, 2, 3, 1, 0] },
  ...
  'G-dim7':   { frets: [3, 4, 3, 4, -1, -1], fingers: [1, 3, 2, 4, 0, 0] },
  ...
  'C#-m7':    { frets: [-1, 4, 2, 4, 2, 4], fingers: [0, 2, 1, 3, 1, 4] },
  'C#-maj7':  { frets: [-1, 4, 3, 1, 1, 1], fingers: [0, 4, 3, 1, 1, 1] },
  ...
  'F#-maj7':  { frets: [2, 2, 3, 3, 4, 2], fingers: [1, 1, 2, 3, 4, 1] },
  'F#-dim':   { frets: [2, -1, 2, 3, 2, -1], fingers: [1, 0, 2, 3, 1, 0] },
  'F#-aug':   { frets: [2, 2, 3, 4, 4, 3], fingers: [1, 1, 2, 4, 3, 2] },
  'F#-sus4':  { frets: [2, 2, 4, 4, 4, 2], fingers: [1, 1, 2, 3, 4, 1] },
  'F#-sus2':  { frets: [2, 2, 4, 4, 2, 2], fingers: [1, 1, 3, 4, 1, 1] },
  'F#-dim7':  { frets: [2, 3, 2, 3, -1, -1], fingers: [1, 3, 2, 4, 0, 0] },
  ...
  'G#-maj7':  { frets: [4, 4, 5, 5, 6, 4], fingers: [1, 1, 2, 3, 4, 1] },
  'G#-dim':   { frets: [4, -1, 4, 5, 4, -1], fingers: [1, 0, 2, 3, 1, 0] },
  'G#-aug':   { frets: [4, 4, 5, 6, 6, 5], fingers: [1, 1, 2, 4, 3, 2] },
  'G#-sus4':  { frets: [4, 4, 6, 6, 6, 4], fingers: [1, 1, 2, 3, 4, 1] },
  'G#-sus2':  { frets: [4, 4, 6, 6, 4, 4], fingers: [1, 1, 3, 4, 1, 1] },
  'G#-dim7':  { frets: [4, 5, 4, 5, -1, -1], fingers: [1, 3, 2, 4, 0, 0] },
