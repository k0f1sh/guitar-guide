...
export const CHORD_VOICINGS: Record<string, ChordVoicing> = {
  ...
  'C-sus4':   { frets: [-1, 3, 5, 5, 6, 3], fingers: [0, 1, 2, 2, 3, 1] },
  'C-sus2':   { frets: [-1, 3, 5, 5, 3, 3], fingers: [0, 1, 2, 2, 1, 1] },
  'C-7sus4':  { frets: [-1, 3, 5, 3, 6, 3], fingers: [0, 1, 2, 1, 3, 1] },
  'C-dim7':   { frets: [-1, 3, 4, 5, 4, 5], fingers: [0, 1, 2, 3, 2, 3] },
  'C-m7b5':   { frets: [-1, 3, 4, 3, 4, 3], fingers: [0, 1, 2, 1, 2, 1] },
  'C-add9':   { frets: [-1, 3, 5, 7, 5, 3], fingers: [0, 1, 2, 3, 2, 1] },
  'C-9':      { frets: [-1, 3, 5, 7, 5, 6], fingers: [0, 1, 2, 4, 2, 3] },
  ...
  'D-sus4':   { frets: [-1, 5, 7, 7, 8, 5], fingers: [0, 1, 2, 2, 3, 1] },
  'D-sus2':   { frets: [-1, 5, 7, 7, 5, 5], fingers: [0, 1, 2, 2, 1, 1] },
  'D-7sus4':  { frets: [-1, 5, 7, 5, 8, 5], fingers: [0, 1, 2, 1, 3, 1] },
  'D-dim7':   { frets: [-1, 5, 6, 7, 6, 7], fingers: [0, 1, 2, 3, 2, 3] },
  'D-m7b5':   { frets: [-1, 5, 6, 5, 6, 5], fingers: [0, 1, 2, 1, 2, 1] },
  'D-add9':   { frets: [-1, 5, 7, 9, 7, 5], fingers: [0, 1, 2, 3, 2, 1] },
  ...
  'G-sus4':   { frets: [3, 5, 5, 5, 3, 3], fingers: [1, 2, 2, 2, 1, 1] },
  'G-sus2':   { frets: [3, 5, 7, 4, 3, 3], fingers: [1, 3, 4, 2, 1, 1] },
  'G-7sus4':  { frets: [3, 5, 3, 5, 3, 3], fingers: [1, 2, 1, 2, 1, 1] },
  'G-dim7':   { frets: [3, 4, 5, 3, 5, 3], fingers: [1, 2, 3, 1, 3, 1] },
  'G-m7b5':   { frets: [3, 4, 3, 3, 3, 3], fingers: [1, 2, 1, 1, 1, 1] },
  'G-add9':   { frets: [3, 5, 5, 4, 3, 5], fingers: [1, 3, 3, 2, 1, 3] },
  ...
  'B-7sus4':  { frets: [-1, 2, 4, 2, 5, 2], fingers: [0, 1, 2, 1, 3, 1] },
  'B-dim7':   { frets: [-1, 2, 3, 4, 3, 4], fingers: [0, 1, 2, 3, 2, 3] },
  'B-m7b5':   { frets: [-1, 2, 3, 2, 3, 2], fingers: [0, 1, 2, 1, 2, 1] },
  'B-add9':   { frets: [-1, 2, 4, 6, 4, 2], fingers: [0, 1, 2, 3, 2, 1] },
  'B-9':      { frets: [-1, 2, 4, 6, 4, 5], fingers: [0, 1, 2, 4, 2, 3] },
